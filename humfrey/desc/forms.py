...
def SparqlQueryForm(*args, **kwargs):
    ...
    class _SparqlQueryForm(forms.Form):
        ...
        common_prefixes = forms.BooleanField(label='Assume common namespace prefixes', initial=False, required=False, help_text="When checked, common prefix declarations are prepended to your query.", default=getattr(setting, 'SPARQL_FORM_COMMON_PREFIXES', True))
